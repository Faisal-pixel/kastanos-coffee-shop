...
import { ArrowLeft, Plus, Minus, X, ShoppingCart, Coffee, Snowflake, Cookie } from "lucide-react";
...
const menuData = {
  hot: [
    { id: "h1", name: 'Drip Coffee (Plain)', price: 2000 },
    { id: "h2", name: 'Green tea', price: 2000 },
    { id: "h3", name: 'Black tea', price: 2000 },
    { id: "h4", name: 'Strawberry/Raspberry tea', price: 2000 },
  ],
  cold: [
    { id: "c1", name: 'Ice Latte', price: 4000 },
    { id: "c2", name: 'Ice Caramel Latte', price: 5000 },
    { id: "c3", name: 'Ice Caramel Macchiato', price: 5000 },
    { id: "c4", name: 'Ice Mocha', price: 5000 },
    { id: "c5", name: 'Honey Cinnamon Latte', price: 5000 },
    { id: "c6", name: 'Iced Delight', price: 2500 },
    { id: "c7", name: 'Strawberry Rhapsody', price: 2500 },
    { id: "c8", name: 'Lemonade lush', price: 3000 }
  ],
  extras: [
        ...
        >
          ...
          >
            <TabsList className="w-full grid grid-cols-4 bg-kastanos-beige/20">
              <TabsTrigger
                value="hot"
                className="data-[state=active]:bg-kastanos-brown data-[state=active]:text-white flex items-center justify-center gap-2 py-3"
              >
                <Coffee />
                <span>Hot</span>
              </TabsTrigger>
              ...
              return (
                <TabsContent key={category} value={category} className="p-4">
                  <h2 className="text-xl font-serif mb-4 text-kastanos-brown">
                    ...
                    {/*Basically saying take the first character, make it in Caps and then concatenate it with the other letters by slicing the first letter*/}
                  </h2>
                    ...
                    {menuData[category as keyof typeof menuData].map((item) => (
                      ...
                      >
                        <div>
                          ...
                          <p className="text-kastanos-bronze font-semibold">
        ...
        >
          <div className="container mx-auto flex justify-between items-center">
            <div>
              ...
              <p className="text-xl font-semibold text-kastanos-brown">
                  ...
                  {cart.items.map((item) => (
                    ...
                    >
                      <div className="flex-1">
                        <p className="font-medium">{item.name}</p>
                        <p className="text-sm text-kastanos-bronze">
                          {formatCurrency(item.price)}
                        </p>
                      </div>
